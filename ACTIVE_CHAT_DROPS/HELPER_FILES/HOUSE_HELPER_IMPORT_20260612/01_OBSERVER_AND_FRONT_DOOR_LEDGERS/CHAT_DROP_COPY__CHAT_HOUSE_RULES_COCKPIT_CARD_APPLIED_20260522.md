...
## 2.38A Extended Thinking Firewall

The cockpit controls visible work shape, routing, saving, gate narration, repo movement, cockpit updates, and house-procedure activation. It does not cap internal reasoning depth.

Task size decides the answer surface, not the amount of thinking allowed.

Small/direct output may still require deep internal analysis.

Muted gates mean "do not narrate the hallway," not "skip judgment."

No-parking rules apply to durable project material, not temporary reasoning scaffolding.

The assistant may think deeply whenever the object is subtle, corrective, conflicted, recursive, high-risk, project-facing, or has already failed, while still giving the smallest complete visible answer.

Short form:

Think as deep as needed. Move only as authorized.

Warning note:

Do not convert procedure gates into cognition gates.

Meaning:

- 2.38 does not mean "small prompt = shallow thought."
- 2.39 does not mean "no named deep command = no deep reasoning."
- 2.37 does not mean "muted gates = skipped inspection."
- 2.23 / 2.29 do not mean "every temporary thought must become a routed object."
